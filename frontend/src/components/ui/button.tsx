...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-blue-600 text-white shadow hover:bg-blue-700/90 hover:shadow-md",
        destructive: "bg-red-600 text-white shadow-sm hover:bg-red-700/90",
        outline: "border-2 border-gray-200 bg-white shadow-sm hover:bg-gray-50 text-gray-900 hover:border-blue-300",
        secondary: "bg-gray-100 text-gray-900 hover:bg-gray-200/80 shadow-sm",
        ghost: "hover:bg-gray-100/80 data-[state=open]:bg-gray-100",
